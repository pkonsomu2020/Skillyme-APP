...
class EmailService {
  ...
  async sendEmail(to, subject, html, text = '') {
    ...
    if (this.resend) {
      ...
      try {
        ...
        const emailData = {
          ...
          html: sanitizedHtml,
          text: sanitizedText || sanitizedHtml.replace(/<[^>]*>/g, ''), // Strip HTML for text version
        };
        ...
        console.log('📧 [FALLBACK] Logging email due to Resend failure:');
        console.log(`   To: ${sanitizedTo}`);
        console.log(`   Subject: ${sanitizedSubject}`);
        console.log(`   Content: ${sanitizedText || sanitizedHtml.substring(0, 100)}...`);
        ...
        const emailLog = {
          ...
          reason: 'Resend API error: ' + error.message
        };
    ...
    console.log('📧 [FALLBACK] Resend not configured, logging email:');
    console.log(`   To: ${sanitizedTo}`);
    console.log(`   Subject: ${sanitizedSubject}`);
    console.log(`   Content: ${sanitizedText || sanitizedHtml.substring(0, 100)}...`);
